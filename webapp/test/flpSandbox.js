		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#jlobatoragroupinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jlobatoragroupinvoices-display": {
								"semanticObject": "jlobatoragroupinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jlobatoragroup.invoices",
									"url": sap.ui.require.toUrl("jlobatoragroup/invoices")
								}
							}
						}
					}
